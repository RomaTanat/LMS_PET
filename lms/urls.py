...
from .views import CourseListView, CourseDetailView, UserProfileView, LeaderboardView, home, about, submit_solution, update_task_status, add_task_comment, mark_as_read
